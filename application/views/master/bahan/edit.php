...
<div class="card-body">
    <div class="">
        <form action="<?=site_url('master/bahan/edit_process')?>" method="post">
            <div class="form-group row">
                <input type="text" class="form-control" value="<?php echo $rs_edit['id_bahan'] ?>" name="id_bahan" hidden>
                <label for="staticEmail" class="col-sm-2 col-form-label">Nama Bahan</label>
                <div class="col-sm-10">
                <input type="text" class="form-control" value="<?php echo $rs_edit['nama_bahan'] ?>" name="nama_bahan">
                </div>
            </div>
            <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label">Harga Beli</label>
                <div class="col-sm-10">
                <input type="text" class="form-control" value="<?php echo $rs_edit['harga_beli'] ?>" name="harga_beli">
                </div>
            </div>
